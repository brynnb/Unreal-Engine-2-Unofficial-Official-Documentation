...
* [Game State: Replication Roles](#game-state-replication-roles)
  + [Roles](#roles)
  + [ROLE\_Authority](#role-authority)
  + [ROLE\_None](#role-none)
  + [ROLE\_DumbProxy](#role-dumbproxy)
    - [Other quirks](#other-quirks)
  + [ROLE\_SimulatedProxy](#role-simulatedproxy)
    - [Non-Pawn ROLE\_SimulatedProxy](#non-pawn-role-simulatedproxy)
    - [Pawn ROLE\_SimulatedProxy](#pawn-role-simulatedproxy)
  + [ROLE\_AutonomousProxy](#role-autonomousproxy)
