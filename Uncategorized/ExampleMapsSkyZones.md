...
* [SkyZones](ExampleMapsSkyZones.md#skyzones)
  ...
  + [Setting up a basic Sky Box](ExampleMapsSkyZones.md#setting-up-a-basic-sky-box)
    ...
    - [Placing the SkyZoneInfo](ExampleMapsSkyZones.md#placing-the-skyzoneinfo)
    - [Lighting the SkyZone](ExampleMapsSkyZones.md#lighting-the-skyzone)
    - [Adding Fog to the SkyZone](ExampleMapsSkyZones.md#adding-fog-to-the-skyzone)
  + [Different Types SkyZones](ExampleMapsSkyZones.md#different-types-skyzones)
...
![skyzoneinfo.gif](../assets/![skyzoneinfo.gif](../assets/skyzoneinfo.gif))
...
![sunlight.jpg](../assets/![sunlight.jpg](../assets/sunlight.jpg))
...
![fogblend1.jpg](../assets/![fogblend1.jpg](../assets/fogblend1.jpg))
...
![fogblend2.jpg](../assets/![fogblend2.jpg](../assets/fogblend2.jpg))
...
![seams.jpg](../assets/![seams.jpg](../assets/seams.jpg))
...
![scale_pan.gif](../assets/![scale_pan.gif](../assets/scale_pan.gif))
...
![prop_skysphere.gif](../assets/![prop_skysphere.gif](../assets/prop_skysphere.gif))
...
* [EM\_SkyZone.zip](../assets/[em_skyzone.zip](../assets/em_skyzone.zip)) (for Unreal Engine 2 build 2226)
* [EM\_SkyZones\_RT.zip](../assets/[em_skyzones_rt.zip](../assets/em_skyzones_rt.zip)) (for Unreal Engine 2 Runtime)
