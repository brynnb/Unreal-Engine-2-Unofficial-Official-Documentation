...
Download the [attached zip file](../assets/examplemenurestricted.zip) and unzip it in your Runtime directory. Next you will need to alter your INI file settings to use the new menus and console. In *UE2Runtime.ini*, in the `[Engine.Engine]` section, change the console to:
