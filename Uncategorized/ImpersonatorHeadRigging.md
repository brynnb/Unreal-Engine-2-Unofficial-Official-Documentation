...
* [Impersonator Head Rigging](ImpersonatorHeadRigging.md#impersonator-head-rigging)
  ...
  + [The Bone Poses](ImpersonatorHeadRigging.md#the-bone-poses)
    ...
    - [Pose (EE) - "Eat" Frame 10](ImpersonatorHeadRigging.md#pose-ee---eat-frame-10) - "Eat" Frame 10)
    - [Pose (Er) - "Earth" Frame 20](ImpersonatorHeadRigging.md#pose-er---earth-frame-20) - "Earth" Frame 20)
    - [Pose (Ih) - "If" Frame 30](ImpersonatorHeadRigging.md#pose-ih---if-frame-30) - "If" Frame 30)
    - [Pose (Oh) - "Ox" Frame 40](ImpersonatorHeadRigging.md#pose-oh---ox-frame-40) - "Ox" Frame 40)
    - [Pose (Oh) - "Oat" Frame 50](ImpersonatorHeadRigging.md#pose-oh---oat-frame-50) - "Oat" Frame 50)
    - [Pose (W/OO) - "Wet" Frame 60](ImpersonatorHeadRigging.md#pose-woo---wet-frame-60) - "Wet" Frame 60)
    - [Pose (S/Z) - "Size" Frame 70](ImpersonatorHeadRigging.md#pose-sz---size-frame-70) - "Size" Frame 70)
    - [Pose (Ch/J) - "Church" Frame 80](ImpersonatorHeadRigging.md#pose-chj---church-frame-80) - "Church" Frame 80)
    - [Pose (F/V) - "Fave" Frame 90](ImpersonatorHeadRigging.md#pose-fv---fave-frame-90) - "Fave" Frame 90)
    - [Pose (Th) - "Though" Frame 100](ImpersonatorHeadRigging.md#pose-th---though-frame-100) - "Though" Frame 100)
    - [Pose (T/L/D) - "Told" Frame 110](ImpersonatorHeadRigging.md#pose-tld---told-frame-110) - "Told" Frame 110)
    - [Pose (B/M/P) - "Bump" Frame 120](ImpersonatorHeadRigging.md#pose-bmp---bump-frame-120) - "Bump" Frame 120)
    - [Pose (N/NG) - "New" Frame 130](ImpersonatorHeadRigging.md#pose-nng---new-frame-130) - "New" Frame 130)
    - [Pose (R) - "Roar" Frame 140](ImpersonatorHeadRigging.md#pose-r---roar-frame-140) - "Roar" Frame 140)
    - [Pose (K/G) - "Cage" Frame 150](ImpersonatorHeadRigging.md#pose-kg---cage-frame-150) - "Cage" Frame 150)
    - [Targets (Eyebrow Up Left) - "EB\_Up\_L" Frame 160 and (Eyebrow Up Right) - "EB\_Up\_R" Frame 170](ImpersonatorHeadRigging.md#targets-eyebrow-up-left---eb_up_l-frame-160-and-eyebrow-up-right---eb_up_r-frame-170) - "EB_Up_L" Frame 160 and (Eyebrow Up Right) - "EB_Up_R" Frame 170)
    - [Targets (Blink Left) - "Blink\_L" Frame 180 and (Blink Right) - "Blink\_R" Frame 190](ImpersonatorHeadRigging.md#targets-blink-left---blink_l-frame-180-and-blink-right---blink_r-frame-190) - "Blink_L" Frame 180 and (Blink Right) - "Blink_R" Frame 190)
