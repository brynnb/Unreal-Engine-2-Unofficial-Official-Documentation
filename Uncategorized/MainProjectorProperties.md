...
* [Main Projector Properties](MainProjectorProperties.md#Main Projector Properties)
  ...
  + [Clipping](MainProjectorProperties.md#Clipping)
    - [bClipBSP](MainProjectorProperties.md#b_ClipBSP)
    - [bClipStaticMesh](MainProjectorProperties.md#b_ClipStaticMesh)
  + [Projecting on Surfaces](MainProjectorProperties.md#Projecting on Surfaces)
    - [bProjectActor](MainProjectorProperties.md#b_ProjectActor)
    - [bProjectBSP](MainProjectorProperties.md#b_ProjectBSP)
    - [bProjectOnAlpha & bProjectOnParallelBSP](MainProjectorProperties.md#b_ProjectOnAlpha  b_ProjectOnParallelBSP)
    - [bProjectOnBackfaces](MainProjectorProperties.md#b_ProjectOnBackfaces)
    - [bProjectOnUnlit](MainProjectorProperties.md#b_ProjectOnUnlit)
    - [bProjectParticles](MainProjectorProperties.md#b_ProjectParticles)
    - [bProjectStaticMesh](MainProjectorProperties.md#b_ProjectStaticMesh)
    - [bProjectTerrain](MainProjectorProperties.md#b_ProjectTerrain)
  + [Miscellaneous Settings](MainProjectorProperties.md#Miscellaneous Settings)
    - [ProjectTag](MainProjectorProperties.md#ProjectTag)
    - [bDynamicAttach](MainProjectorProperties.md#b_DynamicAttach)
    - [bLevelStatic](MainProjectorProperties.md#b_LevelStatic)
    - [bNoProjectOnOwner](MainProjectorProperties.md#b_NoProjectOnOwner)
...
![scale3d.jpg](../assets/scale3d.jpg)
...
![fov.jpg](../assets/fov.jpg)

![fov3d.jpg](../assets/fov3d.jpg)
...
![tracedistance.jpg](../assets/tracedistance.jpg)
...
![project2.jpg](../assets/project2.jpg)
...
![levelstatic1.jpg](../assets/levelstatic1.jpg)

![levelstatic2.jpg](../assets/levelstatic2.jpg)If you hold a weapon, you can also see the projection on the weapon, if bLevelStatic = False.

![levelstatic3.jpg](../assets/levelstatic3.jpg)

![levelstatic4.jpg](../assets/levelstatic4.jpg)For decals such as this graffiti, you better set bLevelStatic to True, but for light and shadow effects you can set it to False, so the light or shadow will also be projected on the players.
