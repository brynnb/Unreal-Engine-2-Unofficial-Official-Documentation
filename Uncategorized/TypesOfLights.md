...
![zonelight.jpg](../assets/zonelight.jpg)
...
![zonelight0.jpg](../assets/zonelight0.jpg)

But if you set AmbientBrightness to respectively 32 and 128, it'll look like this:

![zonelight32.jpg](../assets/zonelight32.jpg)

![zonelight128.jpg](../assets/zonelight128.jpg)If you set it to 255, all the surfaces in the zone will be almost fullbright, so you can hardly see the lighting from the light actors in the map:

![zonelight255.jpg](../assets/zonelight255.jpg)

With AmbientHue and AmbientSaturation you can change the color of the Ambient Lighting:

![zonelightred.jpg](../assets/zonelightred.jpg)

![zonelightblue.jpg](../assets/zonelightblue.jpg)
...
![rotatelight.jpg](../assets/rotatelight.jpg)

![spot1.jpg](../assets/spot1.jpg)

![spot2.jpg](../assets/spot2.jpg)

![spot3.jpg](../assets/spot3.jpg)You can also set the rotation of the light in its properties --> Movement --> Rotation. There you can enter the Pitch and Yaw values you wish (65536 units in unreal represent 360�).
...
![triggerlightproperties.jpg](../assets/triggerlightproperties.jpg)

![triggerproperties.jpg](../assets/triggerproperties.jpg)You can also use more properties if you expand TriggerLight:
...
For more about LightActors and general lighting in Unreal Ed, also see the following documents:[LightingBasics](../Content Creation/Lighting and Textures/LightingBasics.md) - A detailed table of contents to all of the Lighting documents[UsingLights](UsingLights.md) - A general guide to not only using lights but also how to use features associated with lights.[LightingReference](LightingReference.md) - A comprehensive reference for the LightColor and Lighting properties.[LightingOnSurfaces](LightingOnSurfaces.md) - A guide showing how LightActors affect various types of geometry.[SpecialLightingFeatures](SpecialLightingFeatures.md) - A tutorial showing how to set up special lighting features.
