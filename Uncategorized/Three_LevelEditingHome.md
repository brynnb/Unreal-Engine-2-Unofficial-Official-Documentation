...
[日本語訳](https://udn.epicgames.com/Three/LevelEditingHomeJP)  
[中国翻译](LevelEditingHomeCH.md)  
[한국어](LevelEditingHomeKR.md)  
...
**[UE3 Home](WebHome.md)** > Level Creation Home

---

![level.jpg](../assets/level.jpg)

Documentation including references, guides, and tutorials covering the creation of levels and environments including adding scripted gameplay and dynamic interactive animationed events in Unreal Engine 3.
...
[Getting Started: Level Creation](GettingStartedLevels.md)
  ...
  Information about starting out creating levels and game environments. Unreal Editor - Creating World Geometry - Lighting & Shadows - Lightmass - Dominant Lights - Kismet Visual Scripting - Matinee - Cinematics - Level Streaming

Essential Reading

* [Unreal Editor and Tools](EditorAndToolsHome.md) - Guides to using level and content creation tools.
* [Creating Levels](CreatingLevels.md) - An introduction to level creation with Unreal Editor.
* [Design Workflow](DesignWorkflow.md) - Rough detailing of Epic's internal design workflow.
* [Modular Level Design](ModularLevelDesign.md) - Article over building levels from modular pieces.

General Topics

* [Creating Levels](CreatingLevels.md) - An introduction to level creation with Unreal Editor.
* [Modular Level Design](ModularLevelDesign.md) - Article over building levels from modular pieces.
* [Automated Map Build](AutomatedMapBuild.md) - Performing automated builds of maps in the editor.
* [Map Errors](MapErrors.md) - Reference of error message displayed after a map check.
* [Gears Multiplayer Map Theory](GearsMultiplayerMapTheory.md) - Discussion of how multiplayer map flow for Gears of War.
* [Attaching Actors](AttachingActors.md) - Guide to attaching actors to each other in UnrealEd.
* [Actor Grouping](ActorGrouping.md) - Creating and using groups of actors.
* [Massive LOD](MassiveLOD.md) - Guide to using the Massive LOD system to create open vistas in UE3.
* [Using Prefabs](UsingPrefabs.md) - Guide to using prefabs to create reusable grouped actors.
* [Using SplineActors](UsingSplineActors.md) - Guide to using splines.
* [Using SplineLoftActors](UsingSplineLoftActors.md) - Guide to creating lofted meshes along splines.
...
* [UDK Gems](DevelopmentKitGems.md) - A series of example-based tutorials over various topics.
* [Community Links](UDKCommunityLinks.md) - Tutorials, tools, and resources provided by the UDK community.
* [Mod Home](ModHome.md) - Information and resources for mod developers using UT3 or Gears of War.
