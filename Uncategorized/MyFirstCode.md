...
If you are using the UDNBuild or UDNBuildOff, download [myfirstexample_udnbuild.zip](../assets/myfirstexample_udnbuild.zip) and unzip it in your build of the engine.If you are using the 2226 code drop, download [myfirstexample_codedrop.zip](../assets/myfirstexample_codedrop.zip) and unzip it in your build of the engine, or the [myfirstexample_codedrop3323.zip](../assets/myfirstexample_codedrop3323.zip) for newer builds.Once the example is unzipped you must edit INI files to use the example. First edit *User.ini* to specify the type of pawn to use. In the `[DefaultPlayer]` section of *User.ini* set *Class* as follows:
