...
To run the first map you will need to download the [EM\_Triggers1.zip](rsrc/Two/ExampleMapsTriggers/EM_Triggers1.zip) file and extract and put the map and texture package into the appropriate folders of your build. This map is for any 2226 build (such as UDNBuild2226 or [CodeDrop2226](https://udn.epicgames.com/Two/CodeDrop2226)).To run the second map, you will need to download the [EM\_Triggers2.zip](rsrc/Two/ExampleMapsTriggers/EM_Triggers2.zip) file and extract and put the map into the Maps folder of a build that has Epic content from [CodeDrop2226](https://udn.epicgames.com/Two/CodeDrop2226).
