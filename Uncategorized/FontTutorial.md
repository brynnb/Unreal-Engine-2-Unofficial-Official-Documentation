...
![orignumfont.jpg](../assets/![orignumfont.jpg](../assets/orignumfont.jpg))

After messing with the image for a bit the RGB and Alpha channels look like this respectively.

![numfontrgb.jpg](../assets/![numfontrgb.jpg](../assets/numfontrgb.jpg))

![numfontalpha.jpg](../assets/![numfontalpha.jpg](../assets/numfontalpha.jpg))Save the image and now it is time to import the image back into the font. One way to do this is by using the [FontUpdater](https://udn.epicgames.com/Two/FontUpdater) described [above](FontTutorial.md#templink1). In that case you would open a command prompt in your system directory and type the line below. If you are using the "font update" command, see the instructions [above](FontTutorial.md#templink2).**```
...
![finalnumfont.jpg](../assets/![finalnumfont.jpg](../assets/finalnumfont.jpg))
