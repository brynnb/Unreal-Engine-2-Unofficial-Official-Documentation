...
![base_ed_full.jpg](../../assets/![base_ed_full.jpg](../../assets/base_ed_full.jpg))
...
![base_ed_top_menu.jpg](../../assets/![base_ed_top_menu.jpg](../../assets/base_ed_top_menu.jpg))

Firstly, there are the menus at the top of the screen. They are:
...
![cut_add_actor_right_click.gif](../../assets/![cut_add_actor_right_click.gif](../../assets/cut_add_actor_right_click.gif))

#### Groups Browser

![cut_ed_browser_group.jpg](../../assets/![cut_ed_browser_group.jpg](../../assets/cut_ed_browser_group.jpg))

You can group actors together using the Group browser. After your actors are grouped together, you are easily able to find the groups and edit the information in them or make changes. As specific groups are unchecked in the browser, they are removed from view totally in the editor.

![cut_browser_group_new.jpg](../../assets/![cut_browser_group_new.jpg](../../assets/cut_browser_group_new.jpg))

To create a new Group in the Browser simply click the "Create New Group" button. Note - You must have at least one actor selected in the editor to create a new group.**Group Example**
For this example, I am going to create a group from the road barricade here, then have it visible/non-visible. This blockade of the road makes for a perfect group. All the brushes are close together, and make a set of brushes that I would want to either see or not see as a collective group.

![cut_ed_group_mode_preview_1.jpg](../../assets/![cut_ed_group_mode_preview_1.jpg](../../assets/cut_ed_group_mode_preview_1.jpg))

Hence, selecting the first brush I want to add to this group, I create a new group by clicking the "Create New Group" button in the browser, then enter the name I wish to reference the group by and hit enter (thus creating the group).

![cut_ed_group_mode_preview_2.jpg](../../assets/![cut_ed_group_mode_preview_2.jpg](../../assets/cut_ed_group_mode_preview_2.jpg))

When a new group is created, the following prompt appears for you to enter the group name. Note that you may have multiple actors selected when creating a new group.

![cut_ed_group_mode_buttons_2.jpg](../../assets/![cut_ed_group_mode_buttons_2.jpg](../../assets/cut_ed_group_mode_buttons_2.jpg))

In the Groups Browser, these three buttons allow you to add new actors to a current group, delete selected actors from the selected group and refresh the group listings. The Refresh group listings seems to be currently not beneficial, as the groups seem to automatically refresh each time an action is performed when dealing with groups.

![cut_ed_group_mode_preview_3.jpg](../../assets/![cut_ed_group_mode_preview_3.jpg](../../assets/cut_ed_group_mode_preview_3.jpg))
...
![cut_ed_group_mode_browser_unchecked.jpg](../../assets/![cut_ed_group_mode_browser_unchecked.jpg](../../assets/cut_ed_group_mode_browser_unchecked.jpg))
...
![cut_ed_browser_sound.jpg](../../assets/![cut_ed_browser_sound.jpg](../../assets/cut_ed_browser_sound.jpg))

The Sound Browser allows you to open, play and find Unreal Sound Packages. It will also allow you to create new sound packages, insert new sounds into current packages and more.For more information on SoundActors see the [ExampleMapsSounds](../../Uncategorized/ExampleMapsSounds.md) document.

#### Texture Browser

![cut_ed_browser_texture.jpg](../../assets/![cut_ed_browser_texture.jpg](../../assets/cut_ed_browser_texture.jpg))
...
![cut_ed_browser_mesh.jpg](../../assets/![cut_ed_browser_mesh.jpg](../../assets/cut_ed_browser_mesh.jpg))
...
![cut_ed_browser_prefab.jpg](../../assets/![cut_ed_browser_prefab.jpg](../../assets/cut_ed_browser_prefab.jpg))
...
![cut_ed_browser_static_mesh.jpg](../../assets/![cut_ed_browser_static_mesh.jpg](../../assets/cut_ed_browser_static_mesh.jpg))

The Static Mesh browser allows you to view the static meshes that are in your package files, add new static meshes into the environment and in addition also create static meshes from selection made in the environment. As static meshes do not contain any animation data (hence the name) only items without any animation may be used to create static meshes.For more information on StaticMeshes as well as the StaticMesh Browser, see the [StaticMeshesTutorial](../Primitives/StaticMeshesTutorial.md).

#### Animation Browser

![cut_ed_browser_animation.jpg](../../assets/![cut_ed_browser_animation.jpg](../../assets/cut_ed_browser_animation.jpg))

The Animation Browser allows detailed viewing of animations for meshes, skeletal structures, influences and many other mesh animation properties. It allows skeletal meshes to be imported and other animation features.For more information also see the [AnimBrowserTutorial](../Animation/AnimBrowserTutorial.md) and [AnimBrowserReference](../Animation/AnimBrowserReference.md) documents.

### 2D Shape Editor and UnrealScript Editor

![cut_ed_top_buttons_5.jpg](../../assets/![cut_ed_top_buttons_5.jpg](../../assets/cut_ed_top_buttons_5.jpg))

These two buttons will open the 2D Shape Editor and UnrealScript editor.

#### 2D Shape Editor

![base_ed_2dshape.jpg](../../assets/![base_ed_2dshape.jpg](../../assets/base_ed_2dshape.jpg))

The 2D Shape Editor is a tool allowing designers to create more complex shapes then the primitives, though it cannot create extremely complex shapes (e.g. like 3DMax can). This tool is described in much more detail in the 2D [ShapeEditor](../../Uncategorized/ShapeEditor.md) document.It is limited in features, but has not been designed to replace high-end software.

#### UnrealScript Editor

![base_ed_unrealscript.jpg](../../assets/![base_ed_unrealscript.jpg](../../assets/base_ed_unrealscript.jpg))
...
![cut_ed_top_buttons_6.jpg](../../assets/![cut_ed_top_buttons_6.jpg](../../assets/cut_ed_top_buttons_6.jpg))

These two buttons will open the Property Actors in the Unreal Editor. They open the Actor Properties and Surface Properties respectively.

#### Actor Properties

![base_ed_properties_actor.jpg](../../assets/![base_ed_properties_actor.jpg](../../assets/base_ed_properties_actor.jpg))

The Actor Properties browser allows you to view and change information stored in a specific actor. Information stored includes items like the actors name, properties of the actor (e.g. light brightness settings, triggered event names, zone gravity) and many more. The browser allows these entries to be changed for that particular actor - not for that actor class. To see an example of these properties, take a look at the [ActorVariables](../../Uncategorized/ActorVariables.md) doc that describes the default settings for an Actor.

#### Surface Properties

![base_ed_properties_surface.jpg](../../assets/![base_ed_properties_surface.jpg](../../assets/base_ed_properties_surface.jpg))
...
![cut_ed_top_buttons_7.jpg](../../assets/![cut_ed_top_buttons_7.jpg](../../assets/cut_ed_top_buttons_7.jpg))

These buttons all deal with rebuilding (or compiling) your environment. Some of these buttons are only available in the UT2K3 build. In order from left to right they are:

#### Build Geometry

![button_build_geometry.jpg](../../assets/![button_build_geometry.jpg](../../assets/button_build_geometry.jpg))
...
![button_build_lighting.jpg](../../assets/![button_build_lighting.jpg](../../assets/button_build_lighting.jpg))
...
![button_build_changed_lighting.jpg](../../assets/![button_build_changed_lighting.jpg](../../assets/button_build_changed_lighting.jpg))

This works much like the Build Lighting button except for it only rebuilds lights that have been added or altered thus allowing for a faster rebuild.

#### Build Paths

![button_build_paths.jpg](../../assets/![button_build_paths.jpg](../../assets/button_build_paths.jpg))

Whether paths are used for bots or creatures, paths must be built before the AI is able to use them. Paths are made from many different types of actors, and rebuilding them will create paths for the AI to follow based on the current locations of path-based actors.

#### Build Changed Paths (only available in 2107+)

![button_build_changed_paths.jpg](../../assets/![button_build_changed_paths.jpg](../../assets/button_build_changed_paths.jpg))

(This feature is only available from builds 2107 and up)Again, this works like the Build Paths button except for it only rebuilds paths that have been added or altered thus allowing for a faster rebuild.

#### Build All

![button_build_all.jpg](../../assets/![button_build_all.jpg](../../assets/button_build_all.jpg))
...
![button_build_options.jpg](../../assets/![button_build_options.jpg](../../assets/button_build_options.jpg))

This allows you to change your current rebuild options, and either rebuild the environment straight away or use the settings to later rebuild using the Rebuild All button (described above).

![base_ed_properties_rebuild.jpg](../../assets/![base_ed_properties_rebuild.jpg](../../assets/base_ed_properties_rebuild.jpg))

### Play Map

![cut_ed_top_buttons_8.jpg](../../assets/![cut_ed_top_buttons_8.jpg](../../assets/cut_ed_top_buttons_8.jpg))
...
![cut_ed_toolbar_small.jpg](../../assets/![cut_ed_toolbar_small.jpg](../../assets/cut_ed_toolbar_small.jpg))

Next, we have the toolbar down the left had side of the screen. These buttons are all used in the actual creation of your world. They are broken down into six sections, representing different needs that are grouped together. Going from top to bottom, they are:

### Camera and Miscellaneous

![cut_ed_toolbar_1.jpg](../../assets/![cut_ed_toolbar_1.jpg](../../assets/cut_ed_toolbar_1.jpg))

These are options to allow you to move the camera, resize brushes, align textures and several other functions.

#### Camera Movement

![button_camera_movement.jpg](../../assets/![button_camera_movement.jpg](../../assets/button_camera_movement.jpg))

Selecting this option will allow you to move the camera freely in the viewports on the screen. If you select another option from the Camera and Miscellaneous section, you are still able to move the camera freely, though other options are available as well.

#### Edit Vertices

![button_edit_vertex.jpg](../../assets/![button_edit_vertex.jpg](../../assets/button_edit_vertex.jpg))

This button will select the vertex editing mode. While it is possible to edit vertices without this mode being selected, having this feature selected will make vertex editing easier with more being shown in the viewports.

#### Scale Brush

![button_brush_scaling.jpg](../../assets/![button_brush_scaling.jpg](../../assets/button_brush_scaling.jpg))
...
![button_brush_rotate.jpg](../../assets/![button_brush_rotate.jpg](../../assets/button_brush_rotate.jpg))
...
![button_texture_pan.jpg](../../assets/![button_texture_pan.jpg](../../assets/button_texture_pan.jpg))
...
![button_face_drag.jpg](../../assets/![button_face_drag.jpg](../../assets/button_face_drag.jpg))
...
![button_terrain.jpg](../../assets/![button_terrain.jpg](../../assets/button_terrain.jpg))

#### Terrain Editor

This button will open the Terrain Editor, which allows you to create realistic terrain based on height maps. While this document shows the interface of the Terrain Editor, it does not go into any further detail about it. This tool is described in much more detail in the [TerrainTutorial](../Primitives/TerrainTutorial.md) document.

![cut_ed_terrain.jpg](../../assets/![cut_ed_terrain.jpg](../../assets/cut_ed_terrain.jpg))

#### Matinee Editor

![button_matinee.jpg](../../assets/![button_matinee.jpg](../../assets/button_matinee.jpg))

This button will open the Matinee editor, which allows you to make movie like animations using the game engine as the rendering medium. This method of showing cut-scenes is becoming more and more commonly used - partly because of lower load times (the engine does not have to load a video movie file, then reload the level, with all the actors as they were when the movie was started) and also allows the engine to trigger other events as the sequence is being played. You can read more about the Matinee Editor in the [MatineeTutorial](../Matinee/MatineeTutorial.md).

![cut_ed_matinee.jpg](../../assets/![cut_ed_matinee.jpg](../../assets/cut_ed_matinee.jpg))

### Brush Clipping

![cut_ed_toolbar_2.jpg](../../assets/![cut_ed_toolbar_2.jpg](../../assets/cut_ed_toolbar_2.jpg))

These functions allow you to clip your brushes, move the clipping planes and splice brushes apart.

#### Clip Selected Brush

![button_brush_clip.jpg](../../assets/![button_brush_clip.jpg](../../assets/button_brush_clip.jpg))
...
![button_brush_split.jpg](../../assets/![button_brush_split.jpg](../../assets/button_brush_split.jpg))
...
![button_clip_rotate.jpg](../../assets/![button_clip_rotate.jpg](../../assets/button_clip_rotate.jpg))
...
![button_clip_delete.jpg](../../assets/![button_clip_delete.jpg](../../assets/button_clip_delete.jpg))
...
![cut_ed_toolbar_3.jpg](../../assets/![cut_ed_toolbar_3.jpg](../../assets/cut_ed_toolbar_3.jpg))
...
![button_primitive_cube.jpg](../../assets/![button_primitive_cube.jpg](../../assets/button_primitive_cube.jpg))

This function will create a cube or rectangular brush for you. To create a brush from the last used settings, just left click this button, or to input new settings, right click the button, and the following menu will appear.

![cut_builder_cube.jpg](../../assets/![cut_builder_cube.jpg](../../assets/cut_builder_cube.jpg))

The settings for the Cube Primitive are explained below.
...
![button_primitive_curvedstair.jpg](../../assets/![button_primitive_curvedstair.jpg](../../assets/button_primitive_curvedstair.jpg))

This will create a curved (spiral) staircase. The staircase extends to the ground - meaning that each stair created is created from the ground and is raised to the required height.

![cut_builder_curvedstair.jpg](../../assets/![cut_builder_curvedstair.jpg](../../assets/cut_builder_curvedstair.jpg))
...
![button_primitive_spiral_stair.jpg](../../assets/![button_primitive_spiral_stair.jpg](../../assets/button_primitive_spiral_stair.jpg))

This function will create a spiral staircase. While it is somewhat similar to the Curved Staircase, in this brush the stairs will only be as thick as the height of each step. Hence, it is possible to create a spiral that can be 720 degrees in revolution.

![cut_builder_spiralstair.jpg](../../assets/![cut_builder_spiralstair.jpg](../../assets/cut_builder_spiralstair.jpg))
...
![button_primitive_linear_stair.jpg](../../assets/![button_primitive_linear_stair.jpg](../../assets/button_primitive_linear_stair.jpg))

This creates stairs similar to the Create Curved Stair tool, except straight.

![cut_builder_linearstair.jpg](../../assets/![cut_builder_linearstair.jpg](../../assets/cut_builder_linearstair.jpg))
...
![button_primitive_terrain.jpg](../../assets/![button_primitive_terrain.jpg](../../assets/button_primitive_terrain.jpg))

This function will create a special type of brush. This can be used to create BSP based terrain or be vertex edited to suit other requirements. This brush is somewhat like a cube, though it has a mesh on one side, which is tessellated allowing for easy and reliable vertex editing.

![cut_builder_terrain.jpg](../../assets/![cut_builder_terrain.jpg](../../assets/cut_builder_terrain.jpg))

The settings for the Linear Staircase are as follows:
...
![button_primitive_sheet.jpg](../../assets/![button_primitive_sheet.jpg](../../assets/button_primitive_sheet.jpg))

This will create a sheet or flat polygon. This polygon however cannot ever block a player. The polygon created will always be rectangular.

![cut_builder_sheet.jpg](../../assets/![cut_builder_sheet.jpg](../../assets/cut_builder_sheet.jpg))
...
![button_primitive_cylinder.jpg](../../assets/![button_primitive_cylinder.jpg](../../assets/button_primitive_cylinder.jpg))

The Cylinder Brush Builder creates cylinder and pipe brushes.

![cut_builder_cylinder.jpg](../../assets/![cut_builder_cylinder.jpg](../../assets/cut_builder_cylinder.jpg))
...
![button_primitive_cone.jpg](../../assets/![button_primitive_cone.jpg](../../assets/button_primitive_cone.jpg))

The Cone is very similar to the Cylinder brush, though it has a point at one end.

![cut_builder_cone.jpg](../../assets/![cut_builder_cone.jpg](../../assets/cut_builder_cone.jpg))

Settings for the Cone are very similar to the Cylinder, though there are a few additions:
...
![button_primitive_volumetric.jpg](../../assets/![button_primitive_volumetric.jpg](../../assets/button_primitive_volumetric.jpg))
...
![cut_builder_volumetric.jpg](../../assets/![cut_builder_volumetric.jpg](../../assets/cut_builder_volumetric.jpg))
...
![button_primitive_tetra.jpg](../../assets/![button_primitive_tetra.jpg](../../assets/button_primitive_tetra.jpg))
...
![cut_builder_tetra.jpg](../../assets/![cut_builder_tetra.jpg](../../assets/cut_builder_tetra.jpg))
...
![cut_ed_toolbar_4.jpg](../../assets/![cut_ed_toolbar_4.jpg](../../assets/cut_ed_toolbar_4.jpg))
...
![button_build_add.jpg](../../assets/![button_build_add.jpg](../../assets/button_build_add.jpg))
...
![button_build_subtract.jpg](../../assets/![button_build_subtract.jpg](../../assets/button_build_subtract.jpg))
...
![button_build_intersect.jpg](../../assets/![button_build_intersect.jpg](../../assets/button_build_intersect.jpg))
...
![button_build_deintersect.jpg](../../assets/![button_build_deintersect.jpg](../../assets/button_build_deintersect.jpg))
...
![button_build_special.jpg](../../assets/![button_build_special.jpg](../../assets/button_build_special.jpg))

This allows you to add in special brushes. Most of these brushes are not commonly used, or are created using different properties. Hence they do not have a specific button assigned to them.Pressing this button opens this dialogue box:

![cut_window_add_special_1.jpg](../../assets/![cut_window_add_special_1.jpg](../../assets/cut_window_add_special_1.jpg))

You may choose one of the preset brush types from the drop down menu which are described below, or you may enter your own settings and create the brush. Note that you can also select a preset from the list and then make any changes that are required.Note that there is more information available about brushes, brush types and geometry in the Geometry chapter of the Unrealed Manual.
...
![button_build_hardware.jpg](../../assets/![button_build_hardware.jpg](../../assets/button_build_hardware.jpg))
...
![button_build_mover.jpg](../../assets/![button_build_mover.jpg](../../assets/button_build_mover.jpg))

This button will create a Mover Brush. The Mover Brush is a special type of brush that is able to move through the environment with set movement positions. This is covered in more detail in the [MoversTutorial](../Primitives/MoversTutorial.md) document. Right clicking the button will open a list of Mover types from the engine actor classes. The programmers in your company are able to add additional mover classes that may be required for your software.

#### Add Anti-Portal Brush

![button_anti_portal.jpg](../../assets/![button_anti_portal.jpg](../../assets/button_anti_portal.jpg))

This creates an orange volume in outline that is non-solid and not visible in game. They are used for optimization in preventing the renderer from drawing more than it has to. For more detailed information on anti-portals, see the [LevelOptimization](../Techniques/LevelOptimization.md) document.

#### Add Volume

![button_volume.jpg](../../assets/![button_volume.jpg](../../assets/button_volume.jpg))

With this tool you can create effects to simulate certain conditions (such as being underwater or on a ladder) within regions of the level. To select a particular volume type, click on the Add Volume button and choose the desired volume from the menu that appears.

![cut_add_volume.gif](../../assets/![cut_add_volume.gif](../../assets/cut_add_volume.gif))

For more detailed information on volumes, see the [VolumesTutorial](../Primitives/VolumesTutorial.md).

### Selections and Movement Rate

![cut_ed_toolbar_5.jpg](../../assets/![cut_ed_toolbar_5.jpg](../../assets/cut_ed_toolbar_5.jpg))
...
![button_select_show.jpg](../../assets/![button_select_show.jpg](../../assets/button_select_show.jpg))
...
![button_select_hide.jpg](../../assets/![button_select_hide.jpg](../../assets/button_select_hide.jpg))
...
![button_select_show_all.jpg](../../assets/![button_select_show_all.jpg](../../assets/button_select_show_all.jpg))
...
![button_select_invert.jpg](../../assets/![button_select_invert.jpg](../../assets/button_select_invert.jpg))
...
![button_select_camera.jpg](../../assets/![button_select_camera.jpg](../../assets/button_select_camera.jpg))
...
**NOTE: while these buttons may not be available in more current builds, some of their functionality can be found by right clicking on the brush in question and then going to "Transform."**

![cut_ed_toolbar_6.jpg](../../assets/![cut_ed_toolbar_6.jpg](../../assets/cut_ed_toolbar_6.jpg))

These functions allow you to mirror brushes you are creating, and more easily select objects within a brush. They are however only available for the UT2K3 builds.

#### Mirror X

![button_mirror_x.jpg](../../assets/![button_mirror_x.jpg](../../assets/button_mirror_x.jpg))

This button will mirror the brush (the red outline) along the X axis.

#### Mirror Y

![button_mirror_y.jpg](../../assets/![button_mirror_y.jpg](../../assets/button_mirror_y.jpg))

This button will mirror the brush along the Y axis.

#### Mirror Z

![button_mirror_z.jpg](../../assets/![button_mirror_z.jpg](../../assets/button_mirror_z.jpg))

This button will mirror the brush along the Z axis.

#### Select All Inside

![button_select_all_inside.jpg](../../assets/![button_select_all_inside.jpg](../../assets/button_select_all_inside.jpg))

This action will select all objects that intersect the volume that of the builder brush.

#### Clip Z in WireFrame

![button_clip_z_in_wireframe.jpg](../../assets/![button_clip_z_in_wireframe.jpg](../../assets/button_clip_z_in_wireframe.jpg))

Information to be added here.

#### Align View on Actor

![button_align_view.jpg](../../assets/![button_align_view.jpg](../../assets/button_align_view.jpg))
...
![cut_ed_viewport_base.jpg](../../assets/![cut_ed_viewport_base.jpg](../../assets/cut_ed_viewport_base.jpg))
...
![cut_ed_viewport_axis.jpg](../../assets/![cut_ed_viewport_axis.jpg](../../assets/cut_ed_viewport_axis.jpg))

Note that all the views have a set of axis visible in the lower left hand corner. This will show you the X, Y and Z planes and their directions at all times. This is very handy in the 3D view when you are rotating and changing the camera angle.**CAUTION: Unreal Ed uses a Left-Handed coordinate system, but in the top down viewport, the axis depict a Right-Handed coordinate system. The axis in the Top down viewport are INCORRECT. Do not believe their lies. See image below for clarification:**

![handedness.gif](../../assets/![handedness.gif](../../assets/handedness.gif))

### Viewport Controls

![cut_ed_viewport_tool.jpg](../../assets/![cut_ed_viewport_tool.jpg](../../assets/cut_ed_viewport_tool.jpg))
...
![viewport_menu_configure.jpg](../../assets/![viewport_menu_configure.jpg](../../assets/viewport_menu_configure.jpg))
...
![viewport_windows_config.jpg](../../assets/![viewport_windows_config.jpg](../../assets/viewport_windows_config.jpg))
...
![viewport_menu_floating.jpg](../../assets/![viewport_menu_floating.jpg](../../assets/viewport_menu_floating.jpg))
...
![viewport_floating_multiple.jpg](../../assets/![viewport_floating_multiple.jpg](../../assets/viewport_floating_multiple.jpg))
...
![background_image.gif](../../assets/![background_image.gif](../../assets/background_image.gif))

### Viewport Display Modes

![cut_ed_viewport_tool_1.jpg](../../assets/![cut_ed_viewport_tool_1.jpg](../../assets/cut_ed_viewport_tool_1.jpg))
...
![cut_ed_viewport_tool_2.gif](../../assets/![cut_ed_viewport_tool_2.gif](../../assets/cut_ed_viewport_tool_2.gif))
...
![display_more_wireframe.jpg](../../assets/![display_more_wireframe.jpg](../../assets/display_more_wireframe.jpg))
...
![display_more_texture_use.jpg](../../assets/![display_more_texture_use.jpg](../../assets/display_more_texture_use.jpg))
...
![display_more_bsp_cuts.jpg](../../assets/![display_more_bsp_cuts.jpg](../../assets/display_more_bsp_cuts.jpg))
...
![display_more_textured.jpg](../../assets/![display_more_textured.jpg](../../assets/display_more_textured.jpg))
...
![display_more_lighting_only.jpg](../../assets/![display_more_lighting_only.jpg](../../assets/display_more_lighting_only.jpg))
...
![display_more_dynamic.jpg](../../assets/![display_more_dynamic.jpg](../../assets/display_more_dynamic.jpg))
...
![display_more_zone.jpg](../../assets/![display_more_zone.jpg](../../assets/display_more_zone.jpg))
...
![display_more_complexity.jpg](../../assets/![display_more_complexity.jpg](../../assets/display_more_complexity.jpg))
...
![cut_ed_viewport_vertices.jpg](../../assets/![cut_ed_viewport_vertices.jpg](../../assets/cut_ed_viewport_vertices.jpg))
...
![cut_ed_viewport_modes.jpg](../../assets/![cut_ed_viewport_modes.jpg](../../assets/cut_ed_viewport_modes.jpg))

Right Clicking (on the viewport toolbar) will also allow you to change other aspects of what is shown and how it is done.If you Right Click on the bar in any of the view ports, you are given the following options:

![viewport_pulldown_mode.gif](../../assets/![viewport_pulldown_mode.gif](../../assets/viewport_pulldown_mode.gif))

These allow you to select what view mode the window will be in. The different modes are described above.

![viewport_pulldown_view.gif](../../assets/![viewport_pulldown_view.gif](../../assets/viewport_pulldown_view.gif))
...
![viewport_pulldown_actors.jpg](../../assets/![viewport_pulldown_actors.jpg](../../assets/viewport_pulldown_actors.jpg))

This pull down menu allows you to set the display mode for actors in your level.

![viewport_pulldown_window.jpg](../../assets/![viewport_pulldown_window.jpg](../../assets/viewport_pulldown_window.jpg))

From here you can choose between displaying in 16-Bit and 32-Bit color for that viewport in the editor.

## Command Prompt and Settings

![cut_ed_settings.jpg](../../assets/![cut_ed_settings.jpg](../../assets/cut_ed_settings.jpg))
...
![cut_window_command.jpg](../../assets/![cut_window_command.jpg](../../assets/cut_window_command.jpg))
...
![cut_window_vertex_snap.jpg](../../assets/![cut_window_vertex_snap.jpg](../../assets/cut_window_vertex_snap.jpg))
...
![cut_window_drag_grid.jpg](../../assets/![cut_window_drag_grid.jpg](../../assets/cut_window_drag_grid.jpg))
...
![cut_window_rotational_toggle.jpg](../../assets/![cut_window_rotational_toggle.jpg](../../assets/cut_window_rotational_toggle.jpg))
...
![cut_window_maximize_viewport.jpg](../../assets/![cut_window_maximize_viewport.jpg](../../assets/cut_window_maximize_viewport.jpg))
