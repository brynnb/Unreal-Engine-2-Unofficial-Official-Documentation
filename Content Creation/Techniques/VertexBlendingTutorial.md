...
![MatBlendUV0.jpg](../../assets/MatBlendUV0.jpg)

Here are the two textures used.

![VertBlendTut_Source01.jpg](../../assets/VertBlendTut_Source01.jpg)

![VertBlendTut_Source02.jpg](../../assets/VertBlendTut_Source02.jpg)As you can see from the image, the tan bricks blend into the grey bricks, keeping the same mapping coordinates. A few of the many uses for this include adding rust to metal, burnt wood, dirt pathways on rock, moss covered wood, wrinkles in fabric, etc.Start with your textured mesh in 3D Max, similar to below.

![VertBlendTut_Base.jpg](../../assets/VertBlendTut_Base.jpg)
...
![VertBlendTut_VertColor.gif](../../assets/VertBlendTut_VertColor.gif)
...
![material_tree.gif](../../assets/material_tree.gif)
...
![vertexcolor.gif](../../assets/vertexcolor.gif)
...
![VertBlendTut_MatBlendUV0.jpg](../../assets/VertBlendTut_MatBlendUV0.jpg)

## Blending from One Material to Nothing

Getting results similar to this...

![VertBlendTut_MatBlendNot.jpg](../../assets/VertBlendTut_MatBlendNot.jpg)
...
![VertBlendTut_MapChannelSetup.jpg](../../assets/VertBlendTut_MapChannelSetup.jpg)
...
![VertBlendTut_MatBlendUV1.jpg](../../assets/VertBlendTut_MatBlendUV1.jpg)
