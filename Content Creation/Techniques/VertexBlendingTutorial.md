...
This option allows you to blend from one material to another, using the same UV coordinates, as seen below.![MatBlendUV0.jpg](../../assets/MatBlendUV0.jpg)Here are the two textures used.![VertBlendTut_Source01.jpg](../../assets/VertBlendTut_Source01.jpg) ![VertBlendTut_Source02.jpg](../../assets/VertBlendTut_Source02.jpg)As you can see from the image, the tan bricks blend into the grey bricks, keeping the same mapping coordinates. A few of the many uses for this include adding rust to metal, burnt wood, dirt pathways on rock, moss covered wood, wrinkles in fabric, etc.Start with your textured mesh in 3D Max, similar to below.![VertBlendTut_Base.jpg](../../assets/VertBlendTut_Base.jpg)There are two ways to apply colors to the vertices.
