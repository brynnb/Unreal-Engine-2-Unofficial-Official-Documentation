...
![buttons.jpg](../../assets/![buttons.jpg](../../assets/buttons.jpg))

You will get the Static Meshes Window.

![staticmeshes.jpg](../../assets/![staticmeshes.jpg](../../assets/staticmeshes.jpg))
...
![import.jpg](../../assets/![import.jpg](../../assets/import.jpg))
...
![convert.jpg](../../assets/![convert.jpg](../../assets/convert.jpg))
...
![cubes.jpg](../../assets/![cubes.jpg](../../assets/cubes.jpg))
...
![cubes2.jpg](../../assets/![cubes2.jpg](../../assets/cubes2.jpg))
...
![convert2.jpg](../../assets/![convert2.jpg](../../assets/convert2.jpg))

The red brush will now get the same shape as the StaticMesh

![brush.jpg](../../assets/![brush.jpg](../../assets/brush.jpg))
...
![5generals.jpg](../../assets/![5generals.jpg](../../assets/5generals.jpg))
...
![shadow1.jpg](../../assets/![shadow1.jpg](../../assets/shadow1.jpg))

![shadow2.jpg](../../assets/![shadow2.jpg](../../assets/shadow2.jpg))**bUnlit**: if this is True, the Static Mesh will always be bright, if it is False, it will have to get light from Light Actors or ZoneLight.

![unlit1.jpg](../../assets/![unlit1.jpg](../../assets/unlit1.jpg))

![unlit2.jpg](../../assets/![unlit2.jpg](../../assets/unlit2.jpg))**DrawScale**: use this to make the Static Mesh smaller or larger. 1 is the default size, 2 is twice the size, etc...

![scale1.jpg](../../assets/![scale1.jpg](../../assets/scale1.jpg))

![scale2.jpg](../../assets/![scale2.jpg](../../assets/scale2.jpg))**DrawScale3D**: this allows you to change the Draw scale independently along the X, Y or Z axis.

![scale3d1.jpg](../../assets/![scale3d1.jpg](../../assets/scale3d1.jpg))

![scale3d2.jpg](../../assets/![scale3d2.jpg](../../assets/scale3d2.jpg))**DrawType**: it's because of this setting that this object is a Static Mesh. If this option is set to DT\_StaticMesh, the StaticMesh skin you selected in StaticMesh will be used, otherwise it will be ignored. You can turn any object, even Light Actors or weapons into a Static Mesh by setting this setting to DT\_StaticMesh.**Skins**: this is the Skins Array and it will allow you to overwrite the textures assigned to your StaticMesh while still taking advantage of the StaticMesh as an instance. Just select the texture you wish to use from the Texture Browser. Then add as many skins as you need to replace the appropriate material on the StaticMesh (Skin 0 will replace Material 0, Skin 1 will replace Material 1, etc.). Then to replace the texture, simply hit the Use button and it will assign your prescribed texture to that instance of that StaticMesh.

![skinsarray.jpg](../../assets/![skinsarray.jpg](../../assets/skinsarray.jpg))
...
![lightprop.gif](../../assets/![lightprop.gif](../../assets/lightprop.gif))

![light.jpg](../../assets/![light.jpg](../../assets/light.jpg))You can also give the Static Mesh its own **AmbientSound**: expand **Sound** in its properties, select a sound in the Sound Browser and press the Use button in the **AmbientSound** field. You can also give the sound a pitch, a radius and a volume.

![soundprop.gif](../../assets/![soundprop.gif](../../assets/soundprop.gif))
